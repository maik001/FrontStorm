...
<body>
    <!--------MEEEEENUUUUUUUUUUUUSSSS----------->
      <nav class='navbar navbar-expand-lg navbar-dark bg-dark'>
        ...
        <div class='pos-f-t'>
          ...
          <li class='nav-item active'>
          <a class='nav-link' href='#' style='font-family: 'Oxygen';src: url('fonts/Oxygen/Oxygen-Bold.ttf'); font-size: 30px; color:#00ace6;padding-left: 30px;padding-top:15px;'onmouseover='this.style.color='#515151'' onmouseout='this.style.color='#00ace6''>Sair</a>
          </li>
        </ul>
    ...
    <div class='col-md-12'>
          <div class='jumbotron'>
        <p class='display-4'>COMENTÁRIOS</p>
        <hr class='my-4'>
        <div><img src='img/user.svg' style='width: 64px; height: 64px;'></div>
        <p class='lead'>Maik Freitas</p>
        <form class='was-validated'>
          <div class='mb-3'>
            <textarea class='form-control is-invalid' id='validationTextarea' placeholder='DIGITE SEU COMENTÁRIO AQUI...' required></textarea>
            <div class='invalid-feedback'>
            Por favor digite algo
            </div>
          </div>
        <a class='btn btn-primary btn-lg' href='#' role='button'>COMENTAR</a>
        </div>
      </div>
    </div>
  </div>
